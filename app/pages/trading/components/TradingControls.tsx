        ...
        <div className="bg-[#1f2633] rounded-2xl shadow-2xl border border-gray-700/50 overflow-hidden">
          ...
          <div className="flex items-center justify-between text-xs">
            <div className="text-green-400">
              投资收益 <span className="font-medium">+88%</span> <span className="font-medium">+18800</span>
            </div>
            <div className="flex items-center gap-1 text-gray-400">
              ...
              <span className="whitespace-nowrap">账户余额: <span className="text-white">500,000.00</span></span>
            </div>
          </div>
          </div>
        </div>
